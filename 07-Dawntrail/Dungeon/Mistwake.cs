...
public class Mistwake
{
    ...
    public void 雷电飞驰(Event @event, ScriptAccessory accessory)
    {
    ...
    public void 雷电飞驰销毁(Event @event, ScriptAccessory accessory)
    {
    ...
    public void 毒气团飞散销毁(Event @event, ScriptAccessory accessory)
    {
    ...
    public void 霹雷(Event @event, ScriptAccessory accessory)
    {
        ...
        if (isEdgeTTS)accessory.Method.EdgeTTS($"AOE，远离剩余毒球");
