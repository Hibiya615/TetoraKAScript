...
public class E7S
{
    ...
    [ScriptMethod(name: "虚无波动（AOE）", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(19594|20052)$"])]
    public void EmptyWave(Event @event, ScriptAccessory accessory)
    {
        if (@event.ActionId() == 19594) 
        {
    ...
    [ScriptMethod(name: "暗光钉（直线死刑）", eventType: EventTypeEnum.Tether, eventCondition: ["Id:0025"])]
    public void UnshadowedStake(Event @event, ScriptAccessory accessory)
    {
        // 本体读条 19592 暗光钉，连线一名T职释放直线死刑 19508 黑暗之钉，随后对自身释放 15555 暗光钉，再对连线目标释放挡枪直线 19593 白光之钉（范围一致） 
        ...
        dp.Scale = new Vector2(6, 100);
        dp.DestoryAt = 5000;
        accessory.Method.SendDraw(DrawModeEnum.Default, DrawTypeEnum.Rect, dp);
    }

    [ScriptMethod(name: "白光&黑暗奔流", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^195(46|54)$"])]
    public void LightsAndDarknessCourse(Event @event, ScriptAccessory accessory)
    {
        lock (LightsCourseLock)
        {
            ...
            if (LightsCourseCount == 0 || LightsCourseCount == 1)
            {
                ...
                DrawHelper.DrawRect(accessory, @event.SourcePosition(), centerPoint[index], new Vector2(10, 50), 4700, "Light's Course 0 & 1");
            ...
            {
                var index = FindExactPositionIndex(@event.SourcePosition(), BallCheckList);
                DrawHelper.DrawRect(accessory, @event.SourcePosition(), centerPoint[index], new Vector2(10, 50), 4700, "Light's Course 2 & 3");
            }
            ...
            if (LightsCourseCount == 4 || LightsCourseCount == 5)
            {
                ...
                if (@event["ActionId"] == "20067") 
                {
                    ...
                    if (index0 == 1) 
                    {
                        DrawHelper.DrawRect(accessory, BallStartList[4], centerPoint[4], new Vector2(10, 50), 4700, "Light's Course 4 & 5", delay: 4700);
                    } else if (index0 == 2)
                    {
                        DrawHelper.DrawRect(accessory, BallStartList[5], centerPoint[5], new Vector2(10, 50), 4700, "Light's Course 4 & 5", delay: 4700);
                    }
                    DebugMsg($"is drawing 20067", accessory);
                    DrawHelper.DrawRect(accessory, @event.SourcePosition(), centerPoint[index0], new Vector2(10, 25), 4700, "Light's Course 4 & 5");
                    DrawHelper.DrawRect(accessory, @event.SourcePosition(), centerPoint[index0], new Vector2(10, 25), 4000, 
                                    "Light's Course 0 & 1 SAFE", new Vector4(0, 1, 0, 1), 6800);
                } else 
                {
                    var index = FindExactPositionIndex(@event.SourcePosition(), BallCheckList);
                    DrawHelper.DrawRect(accessory, @event.SourcePosition(), centerPoint[index], new Vector2(10, 50), 4700, "Light's Course 4 & 5");
                    DrawHelper.DrawRect(accessory, @event.SourcePosition(), centerPoint[index], new Vector2(10, 50), 4000, 
                                    "Light's Course 0 & 1 SAFE", new Vector4(0, 1, 0, 1), 6800);
                }
            }
            ...
            if (LightsCourseCount == 6 || LightsCourseCount == 7)
            {
                ...
                if (@event["ActionId"] == "20067") 
                {
                    ...
                    if (index0 == 1) 
                    {
                        DrawHelper.DrawRect(accessory, BallStartList[4], centerPoint[4], new Vector2(10, 50), 4700, "Light's Course 6 & 7", delay: 4700);
                    } else if (index0 == 2)
                    {
                        DrawHelper.DrawRect(accessory, BallStartList[5], centerPoint[5], new Vector2(10, 50), 4700, "Light's Course 6 & 7", delay: 4700);
                    }
                    DebugMsg($"is drawing 20067", accessory);
                    DrawHelper.DrawRect(accessory, @event.SourcePosition(), centerPoint[index0], new Vector2(10, 25), 4700, "Light's Course 6 & 7");
                } else 
                {
                    var index = FindExactPositionIndex(@event.SourcePosition(), BallCheckList);
                    DrawHelper.DrawRect(accessory, @event.SourcePosition(), centerPoint[index], new Vector2(10, 50), 4700, "Light's Course 6 & 7");
                }
            }
            ...
            if (LightsCourseCount == 8 || LightsCourseCount == 9 || LightsCourseCount == 10 || LightsCourseCount == 11)
            {
                ...
                if (@event["ActionId"] == "19518") 
                {
                    ...
                    if (index0 == 1) 
                    {
                        ...
                        {
                            DrawHelper.DrawRect(accessory, BallStartList[5], centerPoint[5], new Vector2(10, 50), 4700, "Light's Course 8 & 9 & 10 & 11", new Vector4(1, 0, 0, 1), delay: 4700);
                            DrawHelper.DrawRect(accessory, BallStartList[7], centerPoint[7], new Vector2(10, 50), 4700, "Light's Course 8 & 9 & 10 & 11", new Vector4(1, 0, 0, 1), delay: 4700);
                            DrawHelper.DrawRect(accessory, BallStartList[5], centerPoint[5], new Vector2(10, 50), 2000, "Light's Course 8 & 9 & 10 & 11 SAFE", new Vector4(0, 1, 0, 1), delay: 9400);
                            DrawHelper.DrawRect(accessory, BallStartList[7], centerPoint[7], new Vector2(10, 50), 2000, "Light's Course 8 & 9 & 10 & 11 SAFE", new Vector4(0, 1, 0, 1), delay: 9400);
                        } else 
                        {
                            DrawHelper.DrawRect(accessory, BallStartList[5], centerPoint[5], new Vector2(10, 50), 4700, "Light's Course 8 & 9 & 10 & 11", delay: 6700);
                            DrawHelper.DrawRect(accessory, BallStartList[7], centerPoint[7], new Vector2(10, 50), 4700, "Light's Course 8 & 9 & 10 & 11", delay: 6700);
                        }
                    } else if (index0 == 2)
                    {
                        if (LightsCourseCount == 8 || LightsCourseCount == 9)
                        {
                            DrawHelper.DrawRect(accessory, BallStartList[4], centerPoint[4], new Vector2(10, 50), 4700, "Light's Course 8 & 9 & 10 & 11", new Vector4(1, 0, 0, 1), delay: 4700);
                            DrawHelper.DrawRect(accessory, BallStartList[6], centerPoint[6], new Vector2(10, 50), 4700, "Light's Course 8 & 9 & 10 & 11", new Vector4(1, 0, 0, 1), delay: 4700);
                            DrawHelper.DrawRect(accessory, BallStartList[4], centerPoint[4], new Vector2(10, 50), 2000, "Light's Course 8 & 9 & 10 & 11 SAFE", new Vector4(0, 1, 0, 1), delay: 9400);
                            DrawHelper.DrawRect(accessory, BallStartList[6], centerPoint[6], new Vector2(10, 50), 2000, "Light's Course 8 & 9 & 10 & 11 SAFE", new Vector4(0, 1, 0, 1), delay: 9400);
                        } else 
                        {
                            DrawHelper.DrawRect(accessory, BallStartList[5], centerPoint[5], new Vector2(10, 50), 4700, "Light's Course 8 & 9 & 10 & 11", delay: 4700);
                            DrawHelper.DrawRect(accessory, BallStartList[7], centerPoint[7], new Vector2(10, 50), 4700, "Light's Course 8 & 9 & 10 & 11", delay: 4700);
                        }
                    }
                    var index = FindExactPositionIndex(@event.SourcePosition(), BallCheckList);
                    DrawHelper.DrawRect(accessory, @event.SourcePosition(), centerPoint[index], new Vector2(10, 50), 4700, "Light's Course 8 & 9 & 10 & 11");
                    if (LightsCourseCount == 8 || LightsCourseCount == 9) 
                    {
                        DrawHelper.DrawRect(accessory, @event.SourcePosition(), centerPoint[index], new Vector2(10, 50), 2000, 
                                    "Light's Course 8 & 9 & 10 & 11 SAFE", new Vector4(0, 1, 0, 1), 4800);
                    }
                } else 
                {
                    var index = FindExactPositionIndex(@event.SourcePosition(), BallCheckList);
            ...
            if (LightsCourseCount == 24 || LightsCourseCount == 25 || LightsCourseCount == 26 || LightsCourseCount == 27)
            {
                ...
                if (@event["ActionId"] == "19521")
                {
                    ...
                    {
                        var index = FindExactPositionIndex(@event.SourcePosition(), BallCheckList);
                        DrawHelper.DrawRect(accessory, @event.SourcePosition(), centerPoint[index], new Vector2(10, 50), 4700, "Light's Course 24, 25, 26, 27", new Vector4(1, 0, 0, 1));
                        if (index == 1) 
                        {
                            DrawHelper.DrawRect(accessory, BallStartList[5], centerPoint[5], new Vector2(10, 50), 4700, "Light's Course 24, 25, 26, 27", new Vector4(0, 1, 0, 1), delay: 4700);
                            DrawHelper.DrawRect(accessory, BallStartList[7], centerPoint[7], new Vector2(10, 50), 4700, "Light's Course 24, 25, 26, 27", new Vector4(0, 1, 0, 1), delay: 4700);
                        } else if (index == 2)
                        {
                            DrawHelper.DrawRect(accessory, BallStartList[4], centerPoint[4], new Vector2(10, 50), 4700, "Light's Course 24, 25, 26, 27", new Vector4(0, 1, 0, 1), delay: 4700);
                            DrawHelper.DrawRect(accessory, BallStartList[6], centerPoint[6], new Vector2(10, 50), 4700, "Light's Course 24, 25, 26, 27", new Vector4(0, 1, 0, 1), delay: 4700);
                        }
                    } else
                    {
                        var index = FindExactPositionIndex(@event.SourcePosition(), BallCheckList);
                        DrawHelper.DrawRect(accessory, @event.SourcePosition(), centerPoint[index], new Vector2(10, 50), 4700, "Light's Course 24, 25, 26, 27", new Vector4(0, 1, 0, 1));
                        if (index == 1) 
                        {
                            DrawHelper.DrawRect(accessory, BallStartList[5], centerPoint[5], new Vector2(10, 50), 4700, "Light's Course 24, 25, 26, 27", new Vector4(1, 0, 0, 1), delay: 4700);
                            DrawHelper.DrawRect(accessory, BallStartList[7], centerPoint[7], new Vector2(10, 50), 4700, "Light's Course 24, 25, 26, 27", new Vector4(1, 0, 0, 1), delay: 4700);
                        } else if (index == 2)
                        {
                            DrawHelper.DrawRect(accessory, BallStartList[4], centerPoint[4], new Vector2(10, 50), 4700, "Light's Course 24, 25, 26, 27", new Vector4(1, 0, 0, 1), delay: 4700);
                            DrawHelper.DrawRect(accessory, BallStartList[6], centerPoint[6], new Vector2(10, 50), 4700, "Light's Course 24, 25, 26, 27", new Vector4(1, 0, 0, 1), delay: 4700);
                        }
                    }
