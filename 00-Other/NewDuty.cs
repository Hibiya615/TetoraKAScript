...
public class NewDuty
{
    ...
    #region 7.5 克吕提俄斯魔导工厂
    
    [ScriptMethod(name: "—————— 7.5 克吕提俄斯魔导工厂 ——————", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:"])]
    public void 克吕提俄斯魔导工厂(Event @event, ScriptAccessory accessory) { }
    
    #endregion
    
    #region 7.5 恩欧歼灭战
    
    [ScriptMethod(name: "—————— 7.5 恩欧歼灭战 ——————", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:"])]
    public void 恩欧歼灭战(Event @event, ScriptAccessory accessory) { }
